...
public class NetherOresCore extends BaseMod {
   ...
   private void loadConfig(File var1) {
      ...
      enableHellQuartz = var2.get("WorldGen.Enable", "OverrideNetherQuartz", true).setRequiresMcRestart(true);
