...
public class EntityHellfish extends EntitySilverfish {
   ...
   protected void applyEntityAttributes() {
      ...
      this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(NetherOresCore.hellFishMaxHealth.getDouble(12.5));
      this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.925 + super.rand.nextDouble() * 0.1);
      this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(1.5 + super.rand.nextDouble());
      this.getEntityAttribute(SharedMonsterAttributes.knockbackResistance).setBaseValue(super.rand.nextDouble());
   }
   ...
   protected void updateEntityActionState() {
      ...
      if (!super.worldObj.isRemote) {
                     ...
                     for (int var7 = 0; var7 <= 10 & var7 >= -10; var7 = var7 <= 0 ? 1 - var7 : 0 - var7) {
                        ...
                        if (var8 == NetherOresCore.blockHellfish) {
                           if (!super.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing")) {
                              super.worldObj.setBlock(var2 + var6, var3 + var5, var4 + var7, Blocks.netherrack, 0, 3);
                           } else {
         ...
         if (super.entityToAttack == null && !this.hasPath()) {
            ...
            Block var13 = super.worldObj
               .getBlock(var9 + Facing.offsetsXForSide[var12], var10 + Facing.offsetsYForSide[var12], var11 + Facing.offsetsZForSide[var12]);
