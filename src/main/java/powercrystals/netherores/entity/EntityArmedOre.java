...
public class EntityArmedOre extends Entity {
    ...
    public void onUpdate() {
        if (this._fuse-- <= 0) {
            ...
            Block var1 = super.worldObj.getBlock(
    ...
    private void explode() {
        ...
        if (var1 == this._target) {
            super.worldObj.newExplosion(
                null,
                super.posX,
                super.posY,
                super.posZ,
                NetherOresCore.explosionPower.getInt(),
                true,
                true);
        }
    }
    ...
    protected void readEntityFromNBT(NBTTagCompound var1) {
        ...
        this._target = Block.getBlockFromName(
            var1.hasKey("Target") ? Integer.toString(var1.getInteger("Target")) : var1.getString("STarget"));
        this.setAir(Block.getIdFromBlock(this._target));
    }
