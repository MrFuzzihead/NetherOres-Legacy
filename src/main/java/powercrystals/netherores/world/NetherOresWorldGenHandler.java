    ...
    private void generateNether(World var1, Random var2, int var3, int var4, boolean var5) {
        if (NetherOresCore.enableWorldGen.getBoolean(true)) {
            for (Ores var9 : Ores.values()) {
                if ((var9.getForced() || (var9.isRegisteredSmelting() || var9.isRegisteredMacerator()
                    || NetherOresCore.forceOreSpawn.getBoolean(false)) && !var9.getDisabled())
                    ...
                    while (var10-- > 0) {
                        ...
                        new WorldGenNetherOres(
                            NetherOresCore.getOreBlock(var9.getBlockIndex()),
                            var9.getMetadata(),
                            var9.getBlocksPerGroup()).generate(var1, var2, var11, var12, var13);
                    }
                }
            }
        }
        ...
        if (NetherOresCore.enableHellfish.getBoolean(true)
            && (var5 || !var5 && NetherOresCore.hellFishRetrogen.getBoolean())) {
            ...
            while (var17-- > 0) {
                ...
                new WorldGenNetherOres(NetherOresCore.blockHellfish, 0, var14)
                    .generate(var1, var2, var18, var19, var20);
            }
        }
    }
}
