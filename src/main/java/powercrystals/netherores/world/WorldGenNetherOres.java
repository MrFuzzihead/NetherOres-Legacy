...
public class WorldGenNetherOres extends WorldGenerator {
   ...
   public boolean func_76484_a(World var1, Random var2, int var3, int var4, int var5) {
      ...
      double var12 = var3 + 8 + MathHelper.func_76126_a(var7) * var6 / 8.0F;
      double var14 = var3 + 8 - MathHelper.func_76126_a(var7) * var6 / 8.0F;
      double var16 = var5 + 8 + MathHelper.func_76134_b(var7) * var6 / 8.0F;
      double var18 = var5 + 8 - MathHelper.func_76134_b(var7) * var6 / 8.0F;
      ...
      for (int var20 = 0; var20 <= var6; var20++) {
         ...
         double var29 = (MathHelper.func_76126_a(var20 * 3.141593F / var6) + 1.0F) * var27 + 1.0;
         double var31 = (MathHelper.func_76126_a(var20 * 3.141593F / var6) + 1.0F) * var27 + 1.0;
         int var33 = MathHelper.func_76128_c(var21 - var29 / 2.0);
         int var34 = MathHelper.func_76128_c(var23 - var31 / 2.0);
         int var35 = MathHelper.func_76128_c(var25 - var29 / 2.0);
         int var36 = MathHelper.func_76128_c(var21 + var29 / 2.0);
         int var37 = MathHelper.func_76128_c(var23 + var31 / 2.0);
         int var38 = MathHelper.func_76128_c(var25 + var29 / 2.0);
               ...
               for (int var42 = var34; var42 <= var37; var42++) {
                  ...
                  if (!(var40 * var40 + var43 * var43 >= 1.0)) {
                     for (int var45 = var35; var45 <= var38; var45++) {
                        ...
                        Block var48 = var1.func_147439_a(var39, var42, var45);
                        if (var48 != null
                           && var40 * var40 + var43 * var43 + var46 * var46 < 1.0
                           && var48.isReplaceableOreGen(var1, var39, var42, var45, Blocks.field_150424_aL)) {
                           var1.func_147465_d(var39, var42, var45, this._minableBlock, this._minableBlockMeta, 2);
                        }
                     }
                  }
               }
